...
class TransportBase implements Transport\iBase
{
	...
	/** @var Ads\AdsAudienceConfig $adsConfig Ads config. */
	protected $adsConfig;
	...
	public function start()
	{
		...
		$this->adsConfig = new Ads\AdsAudienceConfig();
	...
	public function send(Message\Adapter $message)
	{
		...
		if (!$isError)
		{
			foreach ($audiences as $audience)
			{
				...
				Ads\AdsAudience::useQueue();
				Ads\AdsAudience::addToAudience($this->adsConfig, $contacts);
			}
		}
	}
