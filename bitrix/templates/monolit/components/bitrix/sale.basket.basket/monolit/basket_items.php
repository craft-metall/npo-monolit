					...
					>
									...
									<div class="centered">
										<table cellspacing="0" cellpadding="0" class="counter">
											...
											?>
												...
												{
													?>
														<td style="text-align: left; padding-left:5px; font-weight:400; color:rgb(34,34,34)"><?=htmlspecialcharsbx($arItem["MEASURE_TEXT"])?></td>
													<?
												}
												?>
											</tr>
						...
						?>
							<td class="control">
								...
								if ($bDeleteColumn):
									?>
									<a class="delete" href="<?=str_replace("#ID#", $arItem["ID"], $arUrls["delete"])?>"
