...
<?if(CSite::InDir('/sendvich-paneli/elementy-obramleniya/')||CSite::InDir('/sendvich-paneli/komplektuyushchie/')):?>
        <td class="pic">
			...
			?>
				...
				if ($showDisplayProps)
				{
					?>
							...
							{
								?>
								<td class="product-item-properties" data-entity="props-block">
	...
	?>
	<td class="measure"><?=$actualItem['ITEM_MEASURE']['TITLE']?></td>
			<?
			foreach ($arParams['PRODUCT_BLOCKS_ORDER'] as $blockName)
			{
				...
				{
					case 'price': ?>
						<td class="product-item-info-container product-item-price-container" data-entity="price-block">
							<?
					...
					case 'buttons':
						?>
							...
							if (!$haveOffers)
							{
								...
								{
									?>
									<td class="product-item-button-container" id="<?=$itemIds['BASKET_ACTIONS']?>">
