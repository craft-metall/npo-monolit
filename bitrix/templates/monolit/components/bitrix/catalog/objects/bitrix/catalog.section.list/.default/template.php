...
<ul id="filter">
<li><a href="" class="current btn" data-filter="*">Все объекты</a></li>
<?
	switch ($arParams['VIEW_MODE'])
	{
		...
		case 'LIST':
			...
			foreach ($arResult['SECTIONS'] as &$arSection)
			{
				...
				?><li id="<?=$this->GetEditAreaId($arSection['ID']);?>"><a href="" class="btn" data-filter=".<? echo $arSection["CODE"];?>"><? echo $arSection["NAME"];?></a><?
