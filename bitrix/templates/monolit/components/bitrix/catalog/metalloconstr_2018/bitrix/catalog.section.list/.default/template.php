...
?>
<div class="iblock-description"><?
if($arIblockDesc = CIBlock::GetArrayByID($arParams['IBLOCK_ID'], 'DESCRIPTION'))
   echo $arIblockDesc;
?></div>
		...
		case 'TILE':
			foreach ($arResult['SECTIONS'] as &$arSection)
			{
				...
				<a
					...
					title="<? echo $arSection['PICTURE']['TITLE']; ?>"
					><img src="<? echo $arSection['PICTURE']['SRC']; ?>" alt="<? echo $arSection['PICTURE']['TITLE']; ?>" title="<? echo $arSection['PICTURE']['TITLE']; ?>"></a><?
				...
				?><div class="more"><a href="<? echo $arSection['SECTION_PAGE_URL']; ?>">Посмотреть каталог ›</a></div></li><?
			}
			unset($arSection);
			break;
		case 'LIST':
