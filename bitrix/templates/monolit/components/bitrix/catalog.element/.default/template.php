	...
	<div class="container-fluid">
		...
		?>
				...
				<div class="slider-block">
					...
					<div class="pay-block">
						<h2>Рассчитать стоимость под свой объект:</h2>
							...
							foreach ($arParams['PRODUCT_PAY_BLOCK_ORDER'] as $blockName)
							{
								switch ($blockName)
								{
									...
									case 'quantity':
										...
										{
											?>
											<div class="product-item-detail-info-container quantity-block" style="<?=(!$actualItem['CAN_BUY'] ? 'display: none;' : '')?>"
												data-entity="quantity-block">
												
												<div class="product-item-amount">
													<div class="product-item-amount-field-container">
													<div class="product-item-detail-info-container-title">
														<?if(CSite::InDir('/sendvich-paneli/komplektuyushchie/krepezhnye-elementy/')||CSite::InDir('/tpa/')):?>
														Примерное количество (<?=$actualItem['ITEM_MEASURE']['TITLE']?>):
														<?else:?>
														Ориентировочный объем (<?=$actualItem['ITEM_MEASURE']['TITLE']?>):
														<?endif;?>
													</div>
													...
													<div class="product-item-amount-description-block">
													<div class="product-item-detail-info-container-title">Стоимость:</div>
													<div class="product-item-detail-price-current" id="<?=$itemIds['PRICE_ID']?>"><?=$price['PRINT_RATIO_PRICE']?></div>
													<span class="product-item-amount-description-container">
															<span id="<?=$itemIds['PRICE_TOTAL']?>" class="price-total"></span>
														</span>
													</div>
												</div>
											</div>
									...
									case 'buttons':
										...
										<div data-entity="main-button-container">
											<div id="<?=$itemIds['BASKET_ACTIONS_ID']?>" style="display: <?=($actualItem['CAN_BUY'] ? '' : 'none')?>;">
												...
												{
													?>
													<div class="product-item-detail-info-container buttons-block">
														<a class="btn <?=$buyButtonClassName?> product-item-detail-buy-button" id="<?=$itemIds['BUY_LINK']?>"
															href="javascript:void(0);">
															<span><?=$arParams['MESS_BTN_BUY']?></span>
														</a>
														<div id="form_id_FID1" class="alx_feedback_popup">Рассчитать индивидуальный проект</div>
													</div>
													<?
												}
												?>
		...
		<div class="description-properties-block">
						<?
						if (!empty($arResult['DISPLAY_PROPERTIES']) || $arResult['SHOW_OFFERS_PROPS'])
						{
							?>
							<div class="product-item-detail-tab-content" data-value="properties">
						...
						{
							?>
							<div class="product-item-detail-tab-content" itemprop="description">
