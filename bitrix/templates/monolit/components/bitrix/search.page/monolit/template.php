...
<?elseif(count($arResult["SEARCH"])>0):?>
	...
	<?foreach($arResult["SEARCH"] as $arItem):?>
		<a class="search-item-title" href="<?echo $arItem["URL"]?>"><?echo $arItem["TITLE_FORMATED"]?></a>
...
<!--	--><?//ShowNote(GetMessage("SEARCH_NOTHING_TO_FOUND"));?>
    ...
    <div>Наименование не найдено. Измените строку поиска.</div>
    <div>
        <p>Если Вы не нашли необходимую информацию на нашем сайте: звоните и мы выполним Ваш заказ.</p>
        <p style="font-size:20px"><a title="Позвоните нам" href="tel:84991103509">+7 (499) 110-35-09</a></p>
        <p>Электронная почта: <a title="Напишите нам" href="mailto:info@npo-monolit.ru">info@npo-monolit.ru</a></p>
    </div>
<?endif;?>
<br /><?if($arParams["DISPLAY_BOTTOM_PAGER"] != "N") echo $arResult["NAV_STRING"]?>
</div>
