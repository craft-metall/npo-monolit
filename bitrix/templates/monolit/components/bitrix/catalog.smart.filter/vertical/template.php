...
//pp($arResult["ITEMS"],"items");
//если для вывода только блок цены то ничего не выводим. 
if ( sizeof($arResult["ITEMS"]) == 1 && isset($arResult["ITEMS"]["BASE"]) ) {
  return false;
}
