...
<div class="bx-subscribe"  id="sender-subscribe">
    ...
    <form style="float:right" id="bx_subscribe_subform_<?=$buttonId?>" role="form" method="post" action="<?=$arResult["FORM_ACTION"]?>">
        <?=bitrix_sessid_post()?>
        <input type="hidden" name="sender_subscription" value="add">
        <div style="display:inline-block;<?=($arParams['HIDE_MAILINGS'] <> 'Y' ? '' : 'display: none;')?>">
            <!--            --><?//if(count($arResult["RUBRICS"])>0):?>
            <!--                <div class="bx-subscribe-desc">--><?//=GetMessage("subscr_form_title_desc")?><!--</div>-->
            <!--            --><?//endif;?>
            <?foreach($arResult["RUBRICS"] as $itemID => $itemValue):?>
                <?if ($itemValue['NAME'] == "Спецпредложения"):?>
                    <div style="visibility: hidden" class="bx_subscribe_checkbox_container">
        ...
        <div style="display: inline-block;">
            ...
            <div class="bx_subscribe_submit_container">
                <button class="sender-btn btn-subscribe" id="bx_subscribe_btn_<?=$buttonId?>"><span><?=GetMessage("subscr_form_button_special")?></span></button>
            </div>
        </div>
    </form>
    <?
    ...
    <form id="bx_subscribe_subform_<?=$buttonId?>" role="form" method="post" action="<?=$arResult["FORM_ACTION"]?>">
        ...
        <div class="bx-input-group">
            <input class="bx-form-control subscribe-input" type="email" name="SENDER_SUBSCRIBE_EMAIL" value="" title="<?=GetMessage("subscr_form_email_title")?>" placeholder="<?=htmlspecialcharsbx(GetMessage('subscr_form_email_title'))?>">
        </div>
