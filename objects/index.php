...
$APPLICATION->SetPageProperty("description", "Быстровозводимые здания из металлоконструкций");
$APPLICATION->SetPageProperty("TITLE", "Реализованные проекты быстровозводимых конструкций -НПО Монолит");
...
?><?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"SEF_FOLDER" => "/objects/",
		"SEF_MODE" => "Y",
		"SEF_URL_TEMPLATES" => array("sections"=>"","section"=>"","element"=>"#ELEMENT_CODE#/","compare"=>"compare.php?action=#ACTION_CODE#","smart_filter"=>"#SECTION_ID#/filter/#SMART_FILTER_PATH#/apply/",),
		"SET_LAST_MODIFIED" => "Y",
		"SET_STATUS_404" => "Y",
		"SET_TITLE" => "Y",
		"SHOW_404" => "Y",
		...
		"TOP_PROPERTY_CODE" => array(0=>"FILTER_CLASS",1=>"",),
