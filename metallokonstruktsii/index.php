...
$APPLICATION->SetPageProperty("description", "Промышленные металлоконструкции монтаж — НПО Монолит");
$APPLICATION->SetPageProperty("TITLE", "Производство металлоконструкций-НПО Монолит.");
$APPLICATION->SetTitle("Металлоконструкции ");
?><?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"COMPATIBLE_MODE" => "Y",
		"COMPONENT_TEMPLATE" => "metalloconstr_2018",
		"CONVERT_CURRENCY" => "N",
		...
		"SECTION_TOP_DEPTH" => "1",
		"SEF_FOLDER" => "/metallokonstruktsii/",
		"SEF_MODE" => "Y",
