...
$APPLICATION->SetPageProperty("TITLE", "Монтаж быстровозводимых сооружений");
$APPLICATION->SetPageProperty("tags", "ангар металлоконструкция,быстровозводимый ангар,быстровозводимый здание здание строительство");
$APPLICATION->SetPageProperty("description", "Монтаж быстровозводимых сооружений под ключ— НПО Монолит");
$APPLICATION->SetTitle("Монтаж быстровозводимых сооружений");
?><?$APPLICATION->IncludeComponent("bitrix:news", "montazh", Array(
	"ADD_ELEMENT_CHAIN" => "Y",	// Включать название элемента в цепочку навигации
		...
		"SEF_FOLDER" => "/uslugi/montazh/",	// Каталог ЧПУ (относительно корня сайта)
